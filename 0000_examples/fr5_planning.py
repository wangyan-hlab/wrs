...
base = wd.World(cam_pos=[-3, 2, 1], lookat_pos=[0, 0, 0.5], w=960, h=720)
gm.gen_frame().attach_to(base)
# object
object = cm.CollisionModel("objects/mug.stl")
object.set_pos(np.array([0, 0.5, 0.5]))
...
# start
start_pos = np.array([0.2,  0.31,  0.6])
...
# goal
goal_pos = np.array([0.2, 0.61, 0.42])
