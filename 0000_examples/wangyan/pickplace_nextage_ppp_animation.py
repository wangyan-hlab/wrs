...
if __name__ == '__main__':
    ...
    # object start
    tubebig_gl_pos = np.array([0.4, 0.05, 0.35])
    tubebig_gl_rotmat = rm.rotmat_from_euler(0, 0, 0)
    ...
    # object goal
    tubebig_gl_goal_pos = np.array([0.4, 0.4, 0.35])
    tubebig_gl_goal_rotmat = rm.rotmat_from_euler(0, 0, 0)
    ...
    robot_s = nxt.Nextage(mode='lft_arm')
    ...
    original_grasp_info_list = gpa.load_pickle_file('tubebig', './', 'nextage_tubebig.pickle')
