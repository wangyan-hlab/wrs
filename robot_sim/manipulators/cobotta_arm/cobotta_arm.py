...
class CobottaArm(mi.ManipulatorInterface):
    ...
    def __init__(self, pos=np.zeros(3), rotmat=np.eye(3), homeconf=np.zeros(6), name='cobotta', enable_cc=True):
        ...
        self.jlc.lnks[0]['meshfile'] = os.path.join(this_dir, "meshes", "base_link.dae")
        ...
        self.jlc.lnks[1]['meshfile'] = os.path.join(this_dir, "meshes", "j1.dae")
        ...
        self.jlc.lnks[6]['meshfile'] = os.path.join(this_dir, "meshes", "j6.dae")
