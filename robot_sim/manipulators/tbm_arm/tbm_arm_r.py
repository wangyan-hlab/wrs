...
class TBMArmR(mi.ManipulatorInterface):
    ...
    def __init__(self, pos=np.zeros(3), rotmat=np.eye(3), homeconf=np.zeros(6), name='tbm_arm', enable_cc=True):
        ...
        self.jlc.lnks[0]['meshfile'] = os.path.join(this_dir, "meshes", "base_r.stl")
        ...
        self.jlc.lnks[1]['meshfile'] = os.path.join(this_dir, "meshes", "joint1_r.stl")
        ...
        self.jlc.lnks[2]['meshfile'] = os.path.join(this_dir, "meshes", "joint2_r.stl")
        ...
        self.jlc.lnks[3]['meshfile'] = os.path.join(this_dir, "meshes", "joint3_r.stl")
        ...
        self.jlc.lnks[4]['meshfile'] = os.path.join(this_dir, "meshes", "joint4_r.stl")
        ...
        self.jlc.lnks[5]['meshfile'] = os.path.join(this_dir, "meshes", "joint5_r.stl")
...
if __name__ == '__main__':
    ...
    seed1 = np.zeros(6)
    seed1[3] = -math.pi / 2
    manipulator_instance = TBMArmR(enable_cc=True)
